...
#I am creating a folder to place all the labelled images into and that will act as our training / testing images.
...
#Created a helper function to transform the training images and their labels into numpy arrays. We take the iumage label, and the image
    #and we append them into our training data array and shuffle them. 
...
#the last one refers to it being a gray scale image.
...
conNN = input_data(shape=[None, IMAGE_SIZE, IMAGE_SIZE, 1], name='input')
...
conNN = fully_connected(conNN, 1024, activation='relu')
...
model = tflearn.DNN(conNN, tensorboard_dir='log')


#Our model fit and validation
